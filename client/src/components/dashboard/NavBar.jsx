...
const NavBar = () => {
  ...
  return (
    <>
        ...
        <div className="navbar-center md:h-100 h-150 w-full items-start mt-10">
          <ul className="menu w-full gap-5">
            ...
            >
              <details open>
                <summary
                 className="z-10 bg-base-300 hover:bg-[#212021]" style={{ opacity: 1 }}>
                  Sections
                </summary>
      ...
      >
        <div className="navbar-start w-full flex flex-col justify-evenly items-center h-25 border-b-1 border-b-slate-600">
          <Link
            to="/dashboard"
            className="font-[rajdhani] font-semibold tracking-widest text-4xl text-center w-full cursor-pointer bg-gradient-to-r from-[#ffffff] to-[#3abdf8] text-transparent bg-clip-text select-none"
          >
          ...
          <p className="text-lg tracking-wide">
            Welcome, <span className="text-amber-600">Ameer👋</span>
          </p>
        </div>
        <div className="navbar-center md:h-100 h-150 w-full items-start mt-10">
          <ul className="menu w-full gap-5">
