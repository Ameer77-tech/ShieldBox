...
import setData from "../../utils/setDataInStorage";
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {showNav && (
          <motion.div
            ...
            className="z-10 navbar md:hidden fixed py-10 px-0 flex-col justify-between items-start overflow-scroll min-h-screen bg-base-300 md:max-w-1/5 max-w-3/5 border-r-white border-r-1 shadow-black"
          >
            ...
            <div className="navbar-center md:h-100 h-150 w-full items-start mt-10">
              <ul className="menu w-full gap-5">
                <li>
                  <details open>
                    <summary className="z-10 bg-base-300 hover:bg-[#212021]">
                      Sections
                    </summary>
      ...
      >
        ...
        <div className="w-full flex items-center gap-3 p-4 cursor-pointer py-2 hover:bg-[#212021] hover:text-white select-none">
          <FiSettings />
